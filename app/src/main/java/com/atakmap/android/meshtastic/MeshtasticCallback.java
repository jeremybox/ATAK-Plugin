        ...
        if (FileSystemUtils.isFile(file)) {
            ...
            if (FileSystemUtils.getFileSize(file) > 1024 * 56) {
                ...
                new Thread(() -> {
                    ...
                    DataPacket dp = new DataPacket(DataPacket.ID_BROADCAST, new byte[]{'S', 'W', 'T'}, Portnums.PortNum.ATAK_FORWARDER_VALUE, DataPacket.ID_LOCAL, System.currentTimeMillis(), messageId, MessageStatus.UNKNOWN, 3, channel, 1);
